    ...
    <form method="post" action="">
        <table width="855" border="0" cellspacing="0" cellpadding="0" class="cpgl_cptj">
            ...
            <tr>
                ...
                <td width="749"><div class="cpgl_cptj_xl">
                        <select name="editor" onchange="javascript:location.replace('<?php echo url('Blog/edit',array('id'=>$this->vars['article']['id']));?>&editor='+this.options[this.selectedIndex].value)" style="margin:5px 0px 0px">
            ...
            <link rel="stylesheet" href="<?php echo config('PUBLIC');?>/Admin/js/markdown/css/style.css">
                <tr>
                    <td  colspan="2"><div class="dsjj_nr1">
                            <textarea style="height: 450px" autocomplete="off" id="text" name="content" class="markdown-textarea"><?php echo $this->vars['article']['content'];?></textarea></div></td>
                </tr>
