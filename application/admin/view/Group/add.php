        ...
        <div class="wzgl_czjl">
            ...
            <table width="855" border="0" cellspacing="0" cellpadding="0" class="right_nr_zhzgl">
                ...
                <tr>
                    ...
                    <td width="738"><input name="group_name" type="text" required="true"  value="<?php echo input('post.group_name');?>" class="right_nr_zhzgl_sr"></td>
                </tr>
                <tr>
                    <td height="212">描述</td>
                    <td><textarea name="group_desc" cols="" rows="" class="right_nr_zhzgl_xl"><?php echo input('post.group_desc');?></textarea></td>
                </tr>
                <tr>
                    <td>&nbsp;</td>
                    <td>&nbsp;</td>
